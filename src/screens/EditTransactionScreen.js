...
export default function EditTransactionScreen({ navigation, route }) {
  ...
  function handleSave() {
    ...
    updateTransaction(transaction.id, { amount: parsed, description: description.trim(), categoryId, date, type });
    navigation.goBack();
  }

  function handleDelete() {
    Alert.alert('Delete Payment', `Delete "${description}"? This cannot be undone.`, [
...
const styles = StyleSheet.create({
  ...
  deleteBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 14, gap: 8, marginBottom: 40 },
  deleteBtnText: { color: '#CC0000', fontSize: 15, fontWeight: '600' },
});
